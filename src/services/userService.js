...
// import { ACTIVATION_PASSWORD_WAY } from '../defaultConfig.js';
...
async function changeEmailRequest(id, email) {
  ...
  // const mailOptions = {
  //     way: ACTIVATION_EMAIL_WAY,
  //     subject: 'Change email',
  //     htmlTitle: 'Change email',
  //   };

  //   await mail.sendActivationEmailLink(email, activationToken, mailOptions);
