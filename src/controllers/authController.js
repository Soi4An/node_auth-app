...
// import { validate } from "../exceptions/validate.js";
...
async function logout(req, res) {
  ...
  res.sendStatus(204);
  // const redirectTo = process.env.CLIENT_URL + '/login';
...
async function refresh(req, res) {
  ...
  // if (!decodedUser) {
  //   // delete regreshToken from DB?
  //   const url = process.env.CLIENT_URL_HASHED
