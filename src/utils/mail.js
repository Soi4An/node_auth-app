...
// import { DEF_MAIL_KEY_OPTIONS, DEF_MAIL_LINK_OPTIONS } from "../defaultConfig.js";
require("dotenv/config");
const nodemailer = require('nodemailer');
const { DEF_MAIL_KEY_OPTIONS, DEF_MAIL_LINK_OPTIONS } = require("../defaultConfig.js");
...
function sendActivationEmailLink(
  ...
  const link = `${process.env.CLIENT_URL}/#/${way}?${paramEmail}&${paramToken}`;
