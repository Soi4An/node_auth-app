...
// import { checkActTokenMW } from '../middlewares/checkActTokenMW.js';
// import { catchErrorMW } from '../middlewares/catchErrorMW.js';
// import { ACTIVATION_ACCOUNT_WAY, ACTIVATION_PASSWORD_WAY } from '../defaultConfig.js';
...
const { ACTIVATION_ACCOUNT_WAY, ACTIVATION_PASSWORD_WAY } = require('../defaultConfig.js');
